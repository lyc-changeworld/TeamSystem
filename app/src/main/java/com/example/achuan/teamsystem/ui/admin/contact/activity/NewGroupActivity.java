...
public class NewGroupActivity extends SimpleActivity {
    ...
    private void save(){
        ...
        if(TextUtils.isEmpty(name)){
            ...
            intent.putExtra(Constant.GROUP_NAME, name);
            //该启动方法会在后者活动销毁后返回信息过来,0代表消息回执码
            startActivityForResult(intent, Constant.GROUP_PICK_CONTACTS_REQUEST_CODE);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        //核对请求码,判断数据来源
        switch (requestCode){
            case Constant.GROUP_PICK_CONTACTS_REQUEST_CODE:
                ...
                if(resultCode==RESULT_OK){
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            //2.获取到传递过来的群组初始成员数组
                            String[] members = data.getStringArrayExtra(Constant.NEW_MEMBERS);
