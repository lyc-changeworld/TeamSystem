 ...
 * 功能：BLE设备连接进行通信后的列表适配器类
 */
public class DeviceLinkAdapter extends RecyclerView.Adapter<DeviceLinkAdapter.ViewHolder> {
    ...
    /*构造方法*/
    public DeviceLinkAdapter(Context mContext, List<MyBean> mList) {
