package com.example.achuan.teamsystem.ui.admin.contact.adapter;
...
public class PublicGroupAdapter extends RecyclerView.Adapter<PublicGroupAdapter.ViewHolder> {
    ...
    protected List<EMGroupInfo> mEMGroupInfoList;
    ...
    /*构造方法*/
    public PublicGroupAdapter(Context mContext, List<EMGroupInfo> mEMGroupInfoList) {
        this.mContext = mContext;
        this.mEMGroupInfoList = mEMGroupInfoList;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int postion) {
        ...
        //先拿到对应群组的对象实例
        EMGroupInfo emGroupInfo=mEMGroupInfoList.get(postion);
        holder.mTvName.setText(emGroupInfo.getGroupName());//设置群名称文本信息
        /***为item设置点击监听事件***/
