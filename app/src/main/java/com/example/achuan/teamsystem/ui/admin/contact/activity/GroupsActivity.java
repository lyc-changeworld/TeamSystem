...
import com.example.achuan.teamsystem.ui.admin.contact.adapter.GroupAdapter;
                ...
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mEMGroupList.clear();
                            mEMGroupList.add(0,null);
                            mEMGroupList.addAll(1,EMClient.getInstance().groupManager().getAllGroups());
                            //刷新列表显示
